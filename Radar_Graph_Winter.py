...
summerData = plotData.iloc[range(0,527),:]
#print(summerData)
...
# Major scale lines
axis_list = np.arange(start=0,stop=10,step=1)
...
for i in range(1,length_of_list):
    ...
    ax.plot(angles,values,linewidth=2,linestyle='solid',label='Panel '+str(i-1))
...
# Give a title
plt.title('Monthly Radiation Analysis by Hour (January) (kWh)')
